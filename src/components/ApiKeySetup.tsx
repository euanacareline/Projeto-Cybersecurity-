            ...
            <div className="relative space-y-6">
              ...
              <div className="pt-2 flex flex-col gap-3">
                <div className="flex gap-3">
                  <button
                    onClick={handleSave}
                    className="flex-1 px-6 py-3 bg-zinc-100 text-black text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-white transition-all shadow-xl shadow-white/5"
                  >
                    Ativar Motor
                  </button>
                  {apiKey && (
                    <button
                      ...
                      className="px-6 py-3 bg-red-500/10 border border-red-500/20 text-red-500 text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-red-500/20 transition-all"
                    >
                      Remover
                    </button>
                  )}
